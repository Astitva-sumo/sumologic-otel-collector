...
require (
	github.com/SumoLogic/sumologic-otel-collector/pkg/configprovider/globprovider v0.124.1-sumo-0
	github.com/SumoLogic/sumologic-otel-collector/pkg/configprovider/providerutil v0.124.1-sumo-0
